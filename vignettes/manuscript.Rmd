...
```{r}
cg <- coglasso(data = multi_omics_sd, pX = 162, nlambda_w = nlambda_w, nlambda_b = nlambda_b, c = cs)
```
...
subnetwork <- igraph::subgraph(sel_graph, c(cirbp_index, igraph::neighbors(sel_graph, cirbp_index)))
plot(subnetwork)
```
